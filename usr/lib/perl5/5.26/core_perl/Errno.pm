...
"x86_64-linux-thread-multi-4.13.3-1-arch" or
	die "Errno architecture (x86_64-linux-thread-multi-4.13.3-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
